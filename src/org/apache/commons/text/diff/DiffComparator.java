...
public class DiffComparator<T> {
     ...
     * Simple constructor.
     * <p>
     * Creates a new instance of DiffComparator.
     * </p>
     * <p>
            ...
            while (i < end1 || j < end2) {
                if (i < end1 && j < end2 && left.get(i).equals(right.get(j))) {
                    ...
                    if (end1 - start1 > end2 - start2) {
                        script.append(new DeleteCommand<>(left.get(i)));
                        ++i;
                    } else {
                        script.append(new InsertCommand<>(right.get(j)));
                        ++j;
                    }
                }
            }
    ...
    private Snake buildSnake(final int start, final int diag, final int end1, final int end2) {
        ...
        while (end - diag < end2
                && end < end1
                && left.get(end).equals(right.get(end - diag))) {
            ++end;
        }
     ...
     * under construction in a {@link DiffComparator DiffComparator}.
     */
